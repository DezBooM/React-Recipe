...
const buttonStyle =
  "rounded-lg py-4 px-8 border border-solid border-gray-600 md:mr-8 mr-1 font-medium"
...
function Recipe() {
  ...
  useEffect(() => {
    getRecipe().catch((err) => console.log(err))
  }, [params.name])

  return (
    <div className="mt-5 md:flex w-full">
      <div className="md:w-1/2 w-full flex flex-col justify-center h-2/3 items-center">
        <h2 className="md:mb-8 mb-2 text-lg md:text-4xl font-semibold">
          {details.title}
        </h2>
        ...
        <div className="flex mb-4 mt-2 md:mt-0 w-full justify-center">
          <button
            ...
            className={`${buttonStyle} ${
              activeTab === "instructions" ? active : inactive
            }`}
          >
            Instructions
          </button>
          <button
            ...
            className={`${buttonStyle} ${
              activeTab === "ingredients" ? active : inactive
            }`}
          >
            Ingredients
          </button>
